...
function renderCards(data){
    ...
    data.forEach(data => {
        ...
        <div class="card mx-4 mt-2" style="width: 18rem;">
                <img style="position: relative;" class="card-img-top" src="${data.image}" alt="Card image cap">
                <i class="fa-regular fa-star card-img-top mt-2 star-icon" style="position: absolute"></i>
                <i class="fa-solid fa-star card-img-top mt-2 star-icon" style="position: absolute"></i>
                <div class="card-body">
